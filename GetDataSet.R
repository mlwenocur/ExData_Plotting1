...
# This file contains two externally used functions: GetCachedData and
# CreateMeteredDataPlot which creates the multi-curve plots given in
# plots 3 and 4.

# Calling Structure:
#   GetCachedData is a closure defined by MakeTableContainerFunction
#       MakeTableContainerFunction calls GetData
#           GetData calls CmpDate
#               CmpDate is self-contained

#   CreateMeteredDataPlot calls MeltMeterData 
#       MeltMeterData is self-contained.
